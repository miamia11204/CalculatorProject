 ...
 * Purpose: A GUI class which instantiates a Calculator object and performs calculator operations on
						that object
...
public class GUICalculator extends JFrame
{
	...
	//Declare GUI references for components and any variables 
	//that will have class scope
	JMenuBar menuBar;
	...
	public GUICalculator() 
	{
		...
		//initialize any variables to default values
		...
		//font for clear, backspace, toggle etc.. buttons
		...
		//apply some styles to the buttons
		...
		//create the text field for the digit display
		screen.setText("0.0");
    ...
    gridBag.setConstraints(screen, gridBagConst);
		...
		//add two components to the JFrame
		...
		//set up the frame using the methods:
