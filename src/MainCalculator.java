...
/**
 * Program Name: MainCalculator.java
 * Purpose: Create a Calculator object
...
public class MainCalculator
{
	 ...
	 *       Returns:  String
	 */
	public String backspace(String value) throws InvalidOperandException
	{
		if (value.isEmpty())
		{
	 ...
	 *       Returns:  String
	 */
	public String findPercentage(String value) throws InvalidOperandException
	{
		if (value.isEmpty())
		{
			throw new InvalidOperandException();
	...
	/*
	 *   Method Name:  findPercentage()
	 *       Purpose:  Add “-“ to the beginning of operand or remove “-“ from the 				operand, depending on the value of flag
	 *       Accepts:  boolean
	 *       Returns:  String
	 */
	public void togglePlusMinus(boolean flag) throws InvalidOperandException 
	{	
	 ...
	 *       Returns:  String
	 */
	public String findSquared(String value) throws InvalidOperandException
	{
		if (value.isEmpty())
		{
			throw new InvalidOperandException();
	 ...
	 *       Returns:  String
	 */
	public String findSquareRoot(String value) throws InvalidOperandException
	{
		if (value.isEmpty())
		{
			throw new InvalidOperandException();
	 ...
	 *       Returns:  void
	 */
	public void buildExpression(String value) throws InvalidOperandException
	{
	 ...
	 *       Returns:  double
	 */
	double calculate() throws InvalidOperandException, ArithmeticException
	{		
		if (this.operand.isEmpty())
		{
			throw new InvalidOperandException();
	 ...
	 *       Returns:  String
	 */
	public String convertHex(String value) throws InvalidOperandException,	LongOperandException
	{
		if (this.operand.length() > 17)
		{
			throw new LongOperandException();
  ...
  /*
	 ...
	 *       Returns:  String
	 */
	public String convertBin(String value) throws InvalidOperandException, LongOperandException
	{
		if (this.operand.length() > 17)
		{
			throw new LongOperandException();
  ...
  /*
	 ...
	 *       Returns:  String
	 */
	public String convertOct(String value) throws InvalidOperandException, LongOperandException
	{
		if (this.operand.length() > 17)
		{
			throw new LongOperandException();
